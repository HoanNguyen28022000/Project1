...
<!-- <body>
	...
	<form action="createAccountSuccessed" method="post" >
		UserName : <input type="text" name="newUsername" height="50dp" /><br> 
		Password : <input type="password" name="newPassworld" height="50dp" /> <input type="submit" name="submit" value="Tạo tài khoản"><br>
	</form>
</body> -->
<body>
	<!-- main -->
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="createAccountSuccessed" method="post">
					<input class="text" type="text" name="newUsername"
						placeholder="Username" required="required"> <input
						class="text email" type="email" name="email" placeholder="Email"
						required="required"> <input class="text" type="password" id="newPass"
						name="newPassworld" placeholder="Password" required="required">
					<input class="text" type="password" name="confirmPassword" id="confirmPass"
				...
				<p>
					Don't have an Account? <a
						href="http://localhost:8080/com.spring-mvc-demo/"> Login
						Now!</a>
				</p>
			</div>
		</div>
