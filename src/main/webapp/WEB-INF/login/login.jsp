...
<body>
	<h1
		style="text-align: center; color: white; size: 100px; padding: 2% 0 0;">LOGIN</h1>
	...
	<h3 class="login-card-footer-text" style="text-align: center;">
		Don't have an account? <a
			href="http://localhost:8080/com.spring-mvc-demo/createAccount"
